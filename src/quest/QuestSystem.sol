...
contract QuestSystem is IQuestSystem, GameRegistryConsumerUpgradeable {
    ...
    function getQuestDefinition(uint32 questId)
        external
        view
        returns (QuestDefinition memory)
    {
     ...
     */
    function activeQuestIdsForAccount(address account)
        external
        view
    ...
    function getActiveQuest(uint256 activeQuestId)
        external
        view
        returns (ActiveQuest memory)
    {
     ...
     */
    function setQuestEnabled(uint32 questId, bool enabled)
        public
     ...
     * @return bool
     */
    function _needsVRF(QuestDefinition memory definition)
        internal
        pure
        returns (bool)
    {
